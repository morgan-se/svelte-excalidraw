 ...
 */
export type { AwarenessUpdate, ExcalidrawDocument, ExcalidrawMultiplayerAdapter, RoomConnection, RoomEvent, RoomPush, RoomUserInfo, } from "./multiplayer/types.js";
export { createDefaultAdapter, type DefaultAdapterOptions, } from "./multiplayer/default-adapter.js";
