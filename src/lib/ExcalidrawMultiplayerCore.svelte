<script lang="ts">
	...
	import type {
		...
		RoomUserInfo,
	} from "$lib/multiplayer/types.js";
	import { applyCollaboratorEvent } from "$lib/multiplayer/core/collaborators.js";
	import { startConnection } from "$lib/multiplayer/core/connection.js";
	import { createMultiplayerSessionState } from "$lib/multiplayer/core/state.svelte.js";
	import { createSyncPipeline } from "$lib/multiplayer/core/sync.js";
